      ...
      <div className="flex gap-4 my-8">
        ...
        <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
          ...
          <div className="flex flex-col sm:ml-4 font-medium">
            ...
            <p className="text-neutral-480 text-gray-600">
            ...
            {dashboardData.bookings.map((item,index) => (
              <tr key={index}>
               ...
               <td className="py-3 px-4 text-gray-700 border-t border-gray-300 text-center">
                ...
                <button className={`text-xs px-3 py-1 rounded-full mx-auto ${item.isPaid ? "bg-green-200 text-green-600" : "bg-amber-200 text-yellow-600"}`}>{item.isPaid ? "Completed" : "Pending"}</button>
