        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center pt-3">
              ...
              {!booking.isPaid && (
                <button className="border border-gray-400 px-4 py-1.5 text-sm rounded-full hover:bg-gray-100 transition-all duration-300 ease-in-out cursor-pointer mt-2">
                  Pay Now
                </button>
              )}
            </div>
